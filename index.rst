...
packages intended for use with Pyramid. Documentation for all of these
projects is collected under the Pylons Project.
...
discussed on the `pylons-discuss mail list <http://groups.google.com/group/pylons-discuss/>`_.
...
.. topic:: Using Support Wisely
   ...
   Before asking a technical question on the mail list(s) or in IRC, please
   ...
   After exhausting these avenues, it's completely appropriate to ask a
   question on the Pylons-discuss mail list or #pylons IRC channel.  When you
...
Pylons Podcasts are a series of audio podcasts from developers of the Pylons
Project.  You can either subscribe in iTunes or Rhythmbox (or your favorite
audio client) using the Feed URL below, or listen to individual podcasts.
